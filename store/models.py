...
from cloudinary.models import CloudinaryField  # ✅ استيراد الحقل الصحيح من Cloudinary
...
class Product(models.Model):
    ...
    # ✅ استخدام Cloudinary لتخزين الصورة
    image = CloudinaryField(_("صورة المنتج"), blank=True, null=True)
